...
<%
    ...
    final String photo = getProfileImage(oUserSession.getDomainIdx(), Integer.parseInt(pUserIdx));
        ...
        <div class="row-fluid">
            ...
            <div class='span10 all'>
                ...
                <table class="table table-bordered">
                    <tr>
                        <th width="80px">이메일</th><td><%=email%></td>
                    </tr>
                    <tr>
                        <th>이름</th><td><%=name%></td>
                    </tr>
                    <tr>
                        <th>사진</th><td><%=photo%></td>
                    </tr>
                    <tr>
                        <th>연락처</th><td><%=tel%></td>
                    </tr>
                    <tr>
                        <th>보조 이메일</th><td><%=noti_email%></td>
                    </tr>
                    <tr>
                        <th>등록일</th><td><%=regdate%></td>
                    </tr>
                    <tr>
                        <th>갱신일</th><td><%=upddate%></td>
                    </tr>
                </table>
