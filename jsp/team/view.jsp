...
<script type="text/javascript">
    ...
    function getTeamInfo() {
        $.getJSON("info.jsp?team_idx=" + getTeamIdx(), function (data) {
            ...
            team.eq(1).html("<img src='" + data.owner_photo + "' style=\"width:30px;height:30px;\" onerror=\"this.src='/html/images/avatar.png'\" />" + data.owner_name); //팀장
    ...
    function getMemberList() {
        $.getJSON("memberList.jsp?team_idx=" + getTeamIdx(), function (data) {
            ...
            // 부모프레임 제어
//            var ifrm = $("iframe", parent.document);
//            var height = document.body.scrollHeight;
//            (ifrm).height = height + 114 * 3 + 20;
//            console.log("ifrm.height=" + ifrm.height);
//                alert("ifrm.height="+ifrm.height);
        });
    }
...
<script type="text/javascript">
    function getMemberRow(idx, photo, name, email, tel) {
        tr = "<tr id=user_" + idx + ">" +
                "<td><img src='" + photo + "' style=\"width:30px;height:30px;\" onerror=\"this.src='/html/images/avatar.png'\" /></td>" +
                "<td>" + name + "</td>" +
    ...
    <div class='span8'>
        ...
        <div class="row-fluid">
            ...
            <div class='span12 all'>
                <button type="button" class="btn pull-right" onclick="javascript:if(confirm('탈퇴하시겠습니까?')){deleteMe();};">팀탈퇴</button><br/><br/>
