...
<%@ include file="./common/include/incSession.jspf" %><%
	//_globalTabNo = 7 ;
	DataSet ds = QueryHandler.executeQuery("SELECT_TASK_OBSERVER_LIST", ownerIdx) ;
	...
	if(ds != null) {
		...
		Task task = null ;
 	 	...
 	 	String th = "<thead><tr><th>#</th><th>"+Html.Icon.USER+"</th><th>태스크</th><th>상태</th></tr></thead>" ;
...
class Task {
	...
	public Task(DataSet ds, UserSession sess) {
		...
		this.v_task_owner = ds.getString(8) ;	 // -- 나한테 참조를 건 사람(태스크 오너)
