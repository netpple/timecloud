...
<%
    ...
    if ("".equals(searchKey) == false) {
        subQuery.append(" AND X.V_DESC LIKE '%" + searchKey + "%'");
    }

    String taskTypeCode = getTaskTypeCode(taskType);

    DataSet ds = QueryHandler.executeQuery("SELECT_DOMAIN_TASK", new String[]{DOMAIN_IDX, DOMAIN_IDX, taskTypeCode}, subQuery.toString());
...
// 	 	String th = "<thead><tr><th>#</th><th>"+Html.Icon.USER+"</th><th>태스크</th><th>구분</th><th>상태</th><th>종료</th></tr></thead>" ;
        String th = "<thead><tr><th>#</th><th>" + Html.Icon.USER + "</th><th>소속팀</th><th>태스크</th></tr></thead>";
...
<%!
    ...
    class Task {
        ...
        public Task(DataSet ds, UserSession sess) {
            ...
            this.n_team_idx = ds.getInt(12);
            this.v_team_name = ds.getString(13);
            try {
                parseTaskTypeCode();
            } catch (Exception e) {
                e.printStackTrace();
