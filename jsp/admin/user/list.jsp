...
<%-- --%>
                <table width="100%">
                    <tr><td><h3>User List</h3></td>
                    <td align="right">
                        <!-- Button trigger modal -->
                        <button class="btn btn-primary btn-lg text-right" data-toggle="modal" data-target="#myModal">사용자 추가</button>
                    </td></tr>
                </table>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id='f1' method='post' action='insert.jsp'>
                                    <table>
                                        <tr><td>이메일:</td><td><input type="text" name="user_email" /></td></tr>
                                        <tr><td>이름:</td><td><input type="text" name="user_name" /></td></tr>
                                        <tr><td>비밀번호 입력:</td><td><input type="password" name="user_passwd" /></td></tr>
                                        <tr><td>비밀번호 확인:</td><td><input type="password" name="user_passwd2" /></td></tr>
                                    </table>
                                </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary" onclick="javascript:check();" >Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
