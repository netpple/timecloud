<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%><%@ page import="java.util.*,java.io.*" %><%@ include file="./common/include/incInit.jspf" %><%@ include file="./common/include/incSession.jspf" %><%!
%><%
	...
	if(pSearchValue == null || "".equals(pSearchValue)) {
		...
		if(pSearchValue.charAt(0) == '@') {
			...
			if(pos >0) {
				...
				params = new Object[]{"%"+searchName+"%", "%"+searchText+"%"} ;
		...
		DataSet dsSearch = QueryHandler.executeQuery("TEST_SELECT_SEARCH", params, repl ) ;
