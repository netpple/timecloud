...
<%@ include file="./common/include/incSession.jspf" %><%
	...
	final String SUCCESS = JavaScript.redirect("프로젝트가 종료처리 되었습니다.", url) ;
	final String FAIL = JavaScript.redirect("프로젝트 종료에 실패했습니다", url) ; 
	...
	int ret = QueryHandler.executeUpdate("UPDATE_PROJECT_OFF"
