...
<%@ include file="./common/include/incSession.jspf" %><%
	...
	String sStartTime = "0000" ; // -- req.getParam("pStartTime","").replace(":","");
	String sEndTime = "0000" ; // -- req.getParam("pEndTime","").replace(":","");
	...
	final String NEW_SEQ = QueryHandler.executeQueryString("SELECT_ACTIVITY_SEQ") ;
	final String MY_KEY = "INSERT_ACTIVITY2" ;
	final String[] MY_PARAM = new String[]{	// -- Task Owner에게 할당되므로, 현재 Task Key가 할당돼야 함.
			NEW_SEQ,
			STR_TASK_IDX,
			sDescription,
			sStartDateTime,
